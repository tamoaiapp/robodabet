// Flood fill a partir dos 4 cantos — remove fundo BRANCO contínuo
import { createRequire } from 'node:module'
const require = createRequire('C:/Users/Notebook/Workspace/postmaster-source-v1.0.30/')
const sharp = require('sharp')

const INPUT = process.argv[2] || 'C:/Users/Notebook/Downloads/010ee1f8-6db1-4c47-aa33-b99ddd34516a.png'
const OUTPUT = process.argv[3] || 'renderer/logo.png'
const THRESHOLD = 720 // soma RGB > 720 = branco suficiente pra ser fundo
